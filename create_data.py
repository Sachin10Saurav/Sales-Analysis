...
def generate_random_address():
  street_names = ['Main', '2nd', '1st', '4th', '5th', 'Park', '6th', '7th', 'Circus', 'Preet', 'Nahar', '8th', 'Arav', 'Moor', 'Raisen', '9th', '10th', 'Lake', 'Sunset', 'Street', 'Aman', 'Temple', 'River', '11th', 'Palak', 'Rish', 'Center', '12th', 'North', 'Patna', 'Raja', 'Shuvajit', 'Pintu', 'Mittal', 'Kshitij', 'John', 'South', 'Diljeet', 'West', 'Cheteshwar', '13th', 'Singh', '14th', 'Verma', 'Mathur', 'Fatima', 'Harman', 'Mangal']
  cities = ['Patna', 'Delhi', 'Rohtak', 'Noida', 'Gurugram', 'Haldia', 'Kolkata', 'Nalanda', 'Mumbai', 'Pune']
  weights = [9,4,5,2,3,3,2,0.5,6,3]
  zips = ['800001', '800011', '800012', '800023', '800034', '800045', '800056', '800067', '800078', '900001']
  state = ['BR', 'DL', 'HR', 'UP', 'HR', 'WB', 'WB', 'BR', 'MH', 'MH']
